...
from db_connection.connectors.ftp import SFTPConnector as RuntimeSFTPConnector
...
class SFTPConnector(BaseConnector[SFTPClient]):
    """Коннектор для SFTP серверов (sync)."""

    def __init__(self) -> None:
        self._runtime_connector = RuntimeSFTPConnector()
    ...
    def get_client(self, connection: DBConnection) -> SFTPClient | None:
        try:
